...
#        load += bus_volts / 5;
    ...
    if (getprop("controls/electric/circuit-breakers/main/flt-comp-lt") and getprop("controls/lighting/flight-comp")) {
        setprop(outPut~"flight-comp-lights", bus_volts);
        load += bus_volts / 30;
    } else {
        setprop(outPut~"flight-comp-lights", 0);
    }
    ...
    # Right COM
    if (getprop("controls/electric/circuit-breakers/center/rh-com2") and getprop("instrumentation/comm[0]/serviceable") and getprop("controls/electric/master-avionics")) {
    ...
    # Right NAV
    if (getprop("controls/electric/circuit-breakers/center/rh-nav2") and getprop("instrumentation/nav[0]/serviceable") and getprop("controls/electric/master-avionics")) {
